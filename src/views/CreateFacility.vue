...
export default defineComponent({
  ...
  async ionViewWillEnter() {
    ...
    // In accordance with the specified requirements, it is essential to treat RETAIL STORE and WAREHOUSE as default elements within the list.
    // These elements may appear at any index within the list structure. Hence to meet requirement we explicitly handling the default nature
    // of RETAIL STORE and WAREHOUSE.
