...
export const FACILITY_IDENTIFICATIONS_UPDATED = SN_FACILITY + '/IDENTIFICATIONS_UPDATED'
export const FACILITY_SHOPIFY_IDENTIFICATION_UPDATED = SN_FACILITY + '/SHOPIFY_IDENTIFICATION_UPDATED'