...
onBeforeMount(async () => {
  ...
  if(props.showBrowserTimeZone) {
    browserTimeZone.value.label = (timeZones.value as any).find((timeZone: any) => timeZone.id.toLowerCase().match(browserTimeZone.value.id.toLowerCase()))?.label
  }
...
function findTimeZone() {
  ...
  filteredTimeZones.value = (timeZones.value as any).filter((timeZone: any) => timeZone.id.toLowerCase().match(searchedString) || timeZone.label.toLowerCase().match(searchedString));
